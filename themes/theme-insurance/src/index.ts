          ...
          fields: [
            {
              ...
              itemSchema: [
                ...
                { key: 'title', label: 'Title', type: 'text', placeholder: 'Welcome to Insurance' },
                {
                  ...
                  label: 'Subtitle',
                  type: 'text',
                  placeholder: 'Trusted protection for your family',
                },
                {
                  key: 'ctaText',
            ...
            },
            {
              ...
              type: 'text',
              default: 'Welcome',
              description: 'Used if no slides are configured',
            },
            {
              key: 'subtitle',
          ...
          fields: [
            {
              ...
              itemSchema: [
                ...
                },
                {
                  ...
                  label: 'Link URL',
                  type: 'text',
                  placeholder: '/post/my-post or /products/life',
                },
                { key: 'active', label: 'Active (show in carousel)', type: 'boolean' },
              ],
            },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: 'footerPhone', label: 'Footer Phone', type: 'text', default: '(028) 3810 0888' },
            {
              ...
              label: 'Footer Email',
              type: 'text',
              default: 'customer@insurance.com',
            },
            {
              key: 'copyrightText',
